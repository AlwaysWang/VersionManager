...
#nav{ width:100%; height:20px; background:black;}
#nav ul { 
 list-style:none; 
} 
#nav ul li{ 
...
<div id="header" >
   ...
   <div  style="text-align: right;">您好  当前时间是  <INPUT name="myclock" type="text" value="" size="8">
...
<div id="nav" class="nav" style="background-color: gray">
<ul>
