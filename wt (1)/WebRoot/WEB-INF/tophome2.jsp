...
#nav{ width:76.5%; height:35px; background:black;}/*100%宽度导航条*/
...
&nbsp;&nbsp;<td><a href="<%=basePath%>user/exit/${roleUser.roleId}" target="_parent" style="color:#FFF; line-height:35px; text-decoration:none;">退出登录</a></td>
</div>
