              ...
              <tr>
                ...
                <td width="518" style="background:url(images/login03.jpg)"><table width="320" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="242" height="50"><input type="text" name="textfield" id="textfield" style="width:164px; height:32px; line-height:34px; background:url(images/inputbg.gif) repeat-x; border:solid 1px #d1d1d1; font-size:9pt; font-family:Verdana, Geneva, sans-serif;" placeholder="用户名"></td>
                  </tr>
                  <tr>
                    <td height="50"><img src="images/password.gif" width="28" height="32"></td>
                    <td height="50">密码</td>
                    <td height="50"><input type="password" name="textfield2" id="textfield2" style="width:164px; height:32px; line-height:34px; background:url(images/inputbg.gif) repeat-x; border:solid 1px #d1d1d1; font-size:9pt;" placeholder="密码"></td>
                  </tr>
                  <tr>
                    <td height="40">&nbsp;</td>
                    <td height="40">&nbsp;</td>
                    <td height="60"><img src="images/login.gif" width="95" height="34" ></td>
                  </tr>
                </table></td>
                <td width="214" style="background:url(images/login04.jpg)" onclick="javascript:login()" >&nbsp;</td>
              </tr>
            </table></td>
          </tr>
          <tr>
